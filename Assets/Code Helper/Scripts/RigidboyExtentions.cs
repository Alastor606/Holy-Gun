...
namespace CodeHelper.Unity
{
    public static class RigidboyExtentions
    {
        ...
        /// <param name="sensivity">Rotation speed</param>
        public static void TransferControl3D<T>(this T self, float speed, float sensivity) where T : Rigidbody
        {
        ...
        public static void FreezeRotation(this Rigidbody2D self, bool value) =>
        ...
        public static void TransferControl2D(this Rigidbody2D self, float speed, float force, KeyCode jumpKey = KeyCode.None)
        {
